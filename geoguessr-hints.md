...
Distilled meta clues per country, for learning and faster plonking. Terse on purpose. **Auto-generated from `data/` — edit the JSON, not this file.**

**Specificity (broad → precise):** `Country` pins the nation · `Region` broad zone (N/S/E/W, biome) · `State` first-level subdivision · `City` specific town · `Special` rare near-pinpoint clue.

**Source codes:** `P` = Plonk It, `GH` = GeoHints, `W` = Wikipedia, `GT` = GeoTips. Each hint is flagged so the webpage can filter by source + specificity.

Countries are grouped by continent, ordered biggest → smallest by area. Per-country **Study** links: Plonk It page (has clickable Street View images) + GeoGuessr map to practice immediately.
...
| Cat | Hint | Src | SV |
|---|---|---|---|
| Country | All coverage = **Gen3 trekker** (some on unusual vehicles, same camera); several **boat trekkers**; only 2 places have a visible unique car | [P](https://www.plonkit.net/madagascar) |  |
| Country | Most coverage has **people walking alongside** the trekker — their clothes ID both the country and the exact region | [P](https://www.plonkit.net/madagascar) |  |
...
| Country | Climate: **extremely dry south/central → tropical north** | [P](https://www.plonkit.net/madagascar) |  |
| Region | Coverage very limited, mostly **on/near the west coast** — land + boat mix (map) | [P](https://www.plonkit.net/madagascar) |  |
| City | **Antananarivo**: hillside coverage overlooking the city, leading up to the **Queen's Palace** | [P](https://www.plonkit.net/madagascar) |  |
| Special | **North (Ambanja area)**: Ambanja = person in dark-blue T-shirt + black sunglasses; Nosy Ambariovato = hilly forested island w/ 3–4 followers (blue/light-red/dark-red shirts) + a north-shore village; Sambirano river = same blue-shirt person (one section: red shirt + white cap & spotted dress) | [P](https://www.plonkit.net/madagascar) |  |
| Special | **Ambiky area**: many palms + brown sandy road, follower w/ grey shirt + brown backpack; beach west = low trees + low mountains NW; south = big solitary green bushes + slight red dirt tinge; **atolls** (central west coast): northernmost = pure sand, see shore-to-shore; others = broad-leaved palms (only 2 southernmost show on the map!) | [P](https://www.plonkit.net/madagascar) |  |
| Special | **Morondava region**: RN8 (Andriamena↔Marofandilia) = car w/ big silver roof rack, very dry & sandy; RN8 trekker = extreme dryness + 4 followers (red/blue/grey/light-blue); **Baobab Avenue** = massive broad-trunked baobabs; Morondava town = bald follower in striped shirt + paved road; smooth beach w/ ocean NW; Belo Sur Mer = palms + white-sand blanket; **Kirindy Mitea NP = the reddest soil in Madagascar**; Manahy = car w/ grey roof rack (or blur shape) + grassy field/sand-dune trekker | [P](https://www.plonkit.net/madagascar) |  |
| Special | **Andavadoaka region**: village w/ shore east (north of town); sandy cape village w/ shore north; town = 3 people (grey hat + light-blue shirt, red & white shirts); trekkers = grey-hat or yellow-shirt person / light-blue shirt (NE); two **cow carts** south of town (black+brown-white cows w/ blue cart; white+black-white cows); bay south: seaside village w/o people, rocky ground w/o people, multi-person village w/ shallow-water walk, fishing-net cluster | [P](https://www.plonkit.net/madagascar) |  |
| Special | **Tsaranoro Massif**: huge monolithic mountain w/ steep sides + 4 followers (partly in forest = darker); small settlement at the NE end; **Toliara** = busy town, the only large one WITHOUT a follower; St Augustin = 2 followers (yellow tank top + blue shirt), also east of town in shrubby hills | [P](https://www.plonkit.net/madagascar) |  |
| Special | **Boat trekkers**: white boat full of people → around Nosy Ambariovato; blue boat → coast south of it; row boat w/ 5 people + wide wooden frame → NW of Ambohimena; Sambirano-river boat = tourist in blue + gondolier in brown (north part at sunset); atoll boat = shirtless driver w/ white cap; north of Andavadoaka = **huge sail** + yellow-blue bow; bay south = smaller sail or 'Diesel' red shirt; St Augustin = 4 people (red/blue/yellow + brown at the front) | [P](https://www.plonkit.net/madagascar) |  |
